    ...
    */    
    public function usernameEntryIsValid() {
         ...
         if ( empty($username) ) {
            ...
            $this->errors["username"] = "Username is not valid. Please make sure username is greater than 2 characters";                
         }
    ...
    public function passwordEntryIsValid() {
        ...
        $confirmpassword = $this->getConfirmPassword();
         ...
         if ( empty($password) ) {
            ...
            $this->errors["password"] = "Password is not valid. Please make sure password is greater than 5 characters";                
         }
         else if (strcasecmp($password, $confirmpassword)){
